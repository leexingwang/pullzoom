...
public class PullToZoomListView extends ListView implements OnScrollListener {
    ...
    private OnHeadShowOrHideListener onHeadShowOrHideListener;
    ...
    interface OnHeadShowOrHideListener{
    ...
    public void setOnHeadShowOrHideListener(OnHeadShowOrHideListener onHeadShowOrHideListener) {
        this.onHeadShowOrHideListener = onHeadShowOrHideListener;
    }
